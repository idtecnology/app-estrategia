                ...
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="toolbar d-flex align-items-start justify-content-center flex-wrap gap-2">
                            <button type="button" class="btn btn-soft-primary timeline-btn btn-sm shadow-none"
                                id="one_month">
                                1M
                            </button>
                            <button type="button" class="btn btn-soft-primary timeline-btn btn-sm shadow-none"
                            ...
                            <button type="button" class="btn btn-soft-primary timeline-btn btn-sm shadow-none active"
                                id="all">
                                ALL
                            </button>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row align-items-end g-0">
                                    ...
                                    <div class="col-6">
                                        <div class="apex-charts crypto-widget"
                                            data-colors='["--vz-danger", "--vz-transparent"]' id="litecoin_sparkline_charts"
                                            dir="ltr"></div>
                                    </div><!-- end col -->
                                </div><!-- end row -->
                            </div><!-- end card body -->
                    ...
                    <div class="swiper-slide">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center">
                                    <img src="{{ URL::asset('build/images/svg/crypto-icons/eth.svg') }}"
                                        class="bg-light rounded-circle p-1 avatar-xs img-fluid shadowarket Stat" alt="">
                    ...
                    <div class="swiper-slide">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center">
                                    <img src="{{ URL::asset('build/images/svg/crypto-icons/xmr.svg') }}"
                                        class="bg-light rounded-circle p-1 avatar-xs img-fluid shadowarket Stat" alt="">
                    ...
                    <div class="swiper-slide">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center">
                                    <img src="{{ URL::asset('build/images/svg/crypto-icons/mkr.svg') }}"
                                        class="bg-light rounded-circle p-1 avatar-xs img-fluid shadowarket Stat" alt="">
                        ...
                        <table class="table align-middle table-nowrap" id="customerTable">
                            ...
                            <tbody class="list form-check-all">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center fw-medium">
                                            <img src="{{ URL::asset('build/images/svg/crypto-icons/aave.svg') }}" alt=""
                                                class="avatar-xxs me-2 shadow rounded-circle" />
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center fw-medium">
                                            <img src="{{ URL::asset('build/images/svg/crypto-icons/mkr.svg') }}" alt=""
                                                class="avatar-xxs me-2 shadow rounded-circle" />
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center fw-medium">
                                            <img src="{{ URL::asset('build/images/svg/crypto-icons/yfi.svg') }}" alt=""
                                                class="avatar-xxs me-2 shadow rounded-circle" />
        ...
        <div class="col-xxl-3">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex mb-3">
                        <div class="flex-shrink-0">
                            <img src="{{ URL::asset('build/images/svg/crypto-icons/fil.svg') }}" alt=""
                                class="avatar-xxs shadow rounded-circle" />
                        </div>
                        <div class="flex-grow-1 ms-3">
                    ...
                    <div class="d-flex mb-3">
                        <div class="flex-shrink-0">
                            <img src="{{ URL::asset('build/images/svg/crypto-icons/dot.svg') }}" alt=""
                                class="avatar-xxs shadow rounded-circle" />
                        </div>
                        <div class="flex-grow-1 ms-3">
                    ...
                    <div>
                        <a href="{{URL::asset('/apps-crypto-transactions')}}" class="btn btn-soft-info w-100">View All Transactions <i
