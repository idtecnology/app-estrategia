                ...
                <div class="d-flex p-3">
                    ...
                    <div>
                        <p class="fs-16 lh-base">Personalized <span class="fw-semibold">Gift
                                Boxes</span>, with attitude, Let's collect your Xmas box <i class="mdi mdi-arrow-right"></i></p>
                        <div class="mt-3">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="d-flex flex-wrap justify-content-evenly">
                    <p class="text-muted mb-0"><i class="mdi mdi-numeric-1-circle text-success fs-18 align-middle me-2 rounded-circle shadow"></i>Completed
                    </p>
                    <p class="text-muted mb-0"><i class="mdi mdi-numeric-3-circle text-info fs-18 align-middle me-2 rounded-circle shadow"></i>In
                        Progress</p>
                    <p class="text-muted mb-0"><i class="mdi mdi-numeric-2-circle text-primary fs-18 align-middle me-2 rounded-circle shadow"></i>To
                        Do</p>
                </div>
            </div>
    ...
    <div class="col-lg-4">
        <div class="card">
            <div class="card-body">
                ...
                <div class="d-flex flex-wrap justify-content-evenly">
                    <p class="text-muted mb-0"><i class="mdi mdi-numeric-3-circle text-success fs-18 align-middle me-2 rounded-circle shadow"></i>Completed
                    </p>
                    <p class="text-muted mb-0"><i class="mdi mdi-numeric-0-circle text-info fs-18 align-middle me-2 rounded-circle shadow"></i>In
                        Progress</p>
                    <p class="text-muted mb-0"><i class="mdi mdi-numeric-8-circle text-primary fs-18 align-middle me-2 rounded-circle shadow"></i>To
                        Do</p>
                </div>
            </div>
            <div class="progress animated-progress bg-soft-primary rounded-bottom rounded-0" style="height: 6px;">
    ...
    <div class="col-lg-4">
        <div class="card">
            <div class="card-body">
                ...
                <div class="d-flex flex-wrap justify-content-evenly">
                    <p class="text-muted mb-0"><i class="mdi mdi-numeric-10-circle text-success fs-18 align-middle me-2 rounded-circle shadow"></i>Completed
                    </p>
                    <p class="text-muted mb-0"><i class="mdi mdi-numeric-3-circle text-info fs-18 align-middle me-2 rounded-circle shadow"></i>In
                        Progress</p>
                    <p class="text-muted mb-0"><i class="mdi mdi-numeric-2-circle text-primary fs-18 align-middle me-2 rounded-circle shadow"></i>To
                    ...
                    <li class="list-group-item px-0">
                        <div class="d-flex">
                            ...
                            <div class="flex-grow-1 ms-2">
                                ...
                                <p class="fs-12 mb-0 text-muted"><i class="mdi mdi-circle fs-10 align-middle text-primary me-1"></i>BTC
                                </p>
                            </div>
                    ...
                    <li class="list-group-item px-0">
                        <div class="d-flex">
                            ...
                            <div class="flex-grow-1 ms-2">
                                ...
                                <p class="fs-12 mb-0 text-muted"><i class="mdi mdi-circle fs-10 align-middle text-info me-1"></i>ETH
                                </p>
                            </div>
                            <div class="flex-shrink-0 text-end">
                    ...
                    <li class="list-group-item px-0">
                        <div class="d-flex">
                            ...
                            <div class="flex-grow-1 ms-2">
                                ...
                                <p class="fs-12 mb-0 text-muted"><i class="mdi mdi-circle fs-10 align-middle text-warning me-1"></i>LTC
                                </p>
                            </div>
                            <div class="flex-shrink-0 text-end">
                    ...
                    <li class="list-group-item px-0 pb-0">
                        <div class="d-flex">
                            ...
                            <div class="flex-grow-1 ms-2">
                                ...
                                <p class="fs-12 mb-0 text-muted"><i class="mdi mdi-circle fs-10 align-middle text-success me-1"></i>DASH
                                </p>
                            </div>
                            <div class="flex-shrink-0 text-end">
                        ...
                        <div class="swiper-slide" style="max-width: 200px;">
                            <div>
                                <div class="bg-soft-info rounded">
                                    <img src="{{URL::asset('build/images/products/img-3.png')}}" alt="" style="max-height: 210px;max-width: auto;" />
                                </div>
                                <div class="pt-3">
                        ...
                        <div class="swiper-slide" style="max-width: 200px;">
                            <div>
                                <div class="bg-soft-success rounded">
                                    <img src="{{URL::asset('build/images/products/img-4.png')}}" alt="" style="max-height: 210px;max-width: auto;" />
                                </div>
                                <div class="pt-3">
                                    <h5 class="text-secondary">$99.94</h5>
                                    <a href="#!">
                        ...
                        <div class="swiper-slide" style="max-width: 200px;">
                            <div>
                                <div class="bg-soft-warning rounded">
                                    <img src="{{URL::asset('build/images/products/img-5.png')}}" alt="" style="max-height: 210px;max-width: auto;" />
                                </div>
                                <div class="pt-3">
                                    <h5 class="text-secondary">$99.94</h5>
                                    <a href="#!">
                        ...
                        <div class="swiper-slide" style="max-width: 200px;">
                            <div>
                                <div class="bg-soft-secondary rounded">
                                    <img src="{{URL::asset('build/images/products/img-6.png')}}" alt="" style="max-height: 210px;max-width: auto;" />
                                </div>
                                <div class="pt-3">
                                    <h5 class="text-secondary">$99.94</h5>
                                    <a href="#!">
            ...
            <div class="card-body">
                <div class="d-flex align-items-center mb-3">
                    ...
                    <div class="flex-grow-1">
                        ...
                        <h5 class="fs-15 fw-semibold mb-0">Half Sleeve T-Shirts (Blue)</h5>
                    </div>
                </div>
                        ...
                        <div>
                            ...
                            <div class="d-flex flex-wrap gap-2 select-color">
                                <div data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Out of Stock">
                                    <button type="button" class="btn avatar-xs p-0 d-flex align-items-center justify-content-center border shadow-none rounded-circle fs-22 text-primary" disabled>
                                        <i class="ri-checkbox-blank-circle-fill"></i>
                                    </button>
                                </div>
                                <div data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="03 Items Available">
                                    <button type="button" class="btn avatar-xs p-0 d-flex align-items-center justify-content-center border shadow-none rounded-circle fs-22 text-secondary">
                                        <i class="ri-checkbox-blank-circle-fill"></i>
                                    </button>
                                </div>
                                <div data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="03 Items Available">
                                    <button type="button" class="btn avatar-xs p-0 d-flex align-items-center justify-content-center border shadow-none rounded-circle fs-22 text-success">
                                        <i class="ri-checkbox-blank-circle-fill"></i>
                                    </button>
                                </div>
                                <div data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="02 Items Available">
                                    <button type="button" class="btn avatar-xs p-0 d-flex align-items-center justify-content-center border shadow-none rounded-circle fs-22 text-info">
                                        <i class="ri-checkbox-blank-circle-fill"></i>
                                    </button>
                                </div>
                            </div>
        ...
        <div class="card card-height-100">
            <div class="card-body">
                <div class="d-flex align-items-center mb-3">
                    ...
                    <div class="flex-grow-1">
                        <p class="text-muted mb-2">Adidas</p>
                        <h5 class="fs-15 fw-semibold mb-0">Half Sleeve T-Shirts (Pink)</h5>
                    </div>
                </div>
                <p class="text-muted pb-1">If you couldn't relate to the information in the previous point, you might be looking for the singlet T-shirt, which is also known as the half T-shirt.</p>
                            ...
                            <ul class="list-unstyled mb-0 pt-2" id="candidate-list">
                                ...
                                <li>
                                    <a href="javascript:void(0);" class="d-flex align-items-center py-2">
                                        <div class="flex-shrink-0 me-2">
                                            <div class="avatar-xs">
                                                <img src="{{URL::asset('build/images/users/avatar-3.jpg')}}" alt="" class="img-fluid rounded-circle candidate-img">
                                            </div>
                                        </div>
                                        <div class="flex-grow-1">
                                ...
                                <li>
                                    <a href="javascript:void(0);" class="d-flex align-items-center py-2">
                                        <div class="flex-shrink-0 me-2">
                                            <div class="avatar-xs">
                                                <img src="{{URL::asset('build/images/users/avatar-4.jpg')}}" alt="" class="img-fluid rounded-circle candidate-img">
                                            </div>
                                        </div>
                                        <div class="flex-grow-1">
                ...
                <div class="col-lg-6">
                    <div class="card-body text-center">
                        <div class="avatar-md mb-3 mx-auto">
                            <img src="{{URL::asset('build/images/users/avatar-1.jpg')}}" alt="" id="candidate-img" class="img-thumbnail rounded-circle shadow-none">
                        </div>
