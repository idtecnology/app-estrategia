...
<div class="row">
    <div class="col-lg-4">
        <div class="card card-height-100">
            <div class="card-body">
                <h5 class="card-title fw-semibold mb-3">Developer Plan</h5>
        ...
        <div class="card" id="apiKeyList">
            <div class="card-header d-flex align-items-center">
                ...
                <div class="d-flex gap-1 flex-wrap">
                    ...
                    <button type="button" class="btn btn-info create-btn" data-bs-toggle="modal" data-bs-target="#api-key-modal"><i class="ri-add-line align-bottom me-1"></i> Add API Key</button>
                </div>
            </div>
            <div class="card-body">
                <div>
