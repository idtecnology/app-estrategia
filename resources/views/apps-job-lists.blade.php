...
<div class="row">
    ...
    <div class="col-xxl-3">
        <div class="card job-list-view-card overflow-hidden" id="job-overview">
            <img src="{{URL::asset('build/images/small/img-10.jpg')}}" alt="" id="cover-img" class="img-fluid background object-cover">
            <div class="card-body">
                ...
                <div class="mt-3">
                    <h5 class="view-title fw-semibold fs-17">Product Designer</h5>
                ...
                <div class="mt-4">
                    <h5 class="mb-3 fw-semibold fs-17">Application Summary</h5>

                    <div>
                        <div id="simple_dount_chart" data-colors='["--vz-primary", "--vz-info", "--vz-danger"]' class="apex-charts" dir="ltr"></div>
                    </div>
                </div>
                <div class="mt-4">
                            ...
                            <div class="text-center mb-4 mt-n5 pt-2">
                                <div class="position-relative d-inline-block">
                                    ...
                                    <div class="avatar-lg p-1">
                                        <div class="avatar-title bg-light rounded-circle">
                                            <img src="{{URL::asset('build/images/users/multi-user.jpg')}}" id="companylogo-img" class="avatar-md rounded-circle object-cover" />
                                        </div>
                                    </div>
                                </div>
