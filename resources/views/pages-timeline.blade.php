                    ...
                    <div class="timeline-item left">
                        ...
                        <div class="content">
                            ...
                            <div class="row border border-dashed rounded gx-2 p-2">
                                <div class="col-3">
                                    <img src="{{ URL::asset('build/images/small/img-2.jpg') }}" alt="" class="img-fluid rounded shadow">
                                </div>
                                <!--end col-->
                                <div class="col-3">
                                    <img src="{{ URL::asset('build/images/small/img-3.jpg') }}" alt="" class="img-fluid rounded shadow">
                                </div>
                                <!--end col-->
                                <div class="col-3">
                                    <img src="{{ URL::asset('build/images/small/img-4.jpg') }}" alt="" class="img-fluid rounded shadow">
                                </div>
                                <!--end col-->
                                <div class="col-3">
                                    <img src="{{ URL::asset('build/images/small/img-6.jpg') }}" alt="" class="img-fluid rounded shadow">
                                </div>
                                <!--end col-->
                            </div>
                            <!--end row-->
                            ...
                            <div class="col-12">
                                <div class="timeline-box shadow">
                                    <div class="timeline-text">
                                        ...
                                        <div class="row border border-dashed rounded gx-2 p-2">
                                            <div class="col-3">
                                                <a href="javascript:void(0);"><img src="{{ URL::asset('build/images/small/img-7.jpg') }}"
                                                        alt="" class="img-fluid rounded shadow"></a>
                                            </div>
                                            <!--end col-->
                                            <div class="col-3">
                                                <a href="javascript:void(0);"><img src="{{ URL::asset('build/images/small/img-3.jpg') }}"
                                                        alt="" class="img-fluid rounded shadow"></a>
                                            </div>
                                            <!--end col-->
                                            <div class="col-3">
                                                <a href="javascript:void(0);"><img src="{{ URL::asset('build/images/small/img-10.jpg') }}"
                                                        alt="" class="img-fluid rounded shadow"></a>
                                            </div>
                                            <!--end col-->
                                            <div class="col-3">
                                                <a href="javascript:void(0);"><img src="{{ URL::asset('build/images/small/img-9.jpg') }}"
                                                        alt="" class="img-fluid rounded shadow"></a>
                                            </div>
                                            <!--end col-->
                                        </div>
