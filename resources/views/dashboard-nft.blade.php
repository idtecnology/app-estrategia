                    ...
                    <div data-simplebar style="max-height: 365px;">
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item list-group-item-action">
                                <div class="d-flex align-items-center">
                                    <img src="{{URL::asset('build/images/users/avatar-10.jpg')}}" alt="" class="avatar-xs object-cover rounded-circle">
                                    <div class="ms-3 flex-grow-1">
                            ...
                            <li class="list-group-item list-group-item-action">
                                <div class="d-flex align-items-center">
                                    <img src="{{URL::asset('build/images/nft/img-01.jpg')}}" alt="" class="avatar-xs object-cover rounded-circle">
                                    <div class="ms-3 flex-grow-1">
                                        <a href="#!">
                            ...
                            <li class="list-group-item list-group-item-action">
                                <div class="d-flex align-items-center">
                                    <img src="{{URL::asset('build/images/nft/img-04.jpg')}}" alt="" class="avatar-xs object-cover rounded-circle">
                                    <div class="ms-3 flex-grow-1">
                                        <a href="#!">
                            ...
                            <li class="list-group-item list-group-item-action">
                                <div class="d-flex align-items-center">
                                    <img src="{{URL::asset('build/images/nft/img-06.jpg')}}" alt="" class="avatar-xs object-cover rounded-circle">
                                    <div class="ms-3 flex-grow-1">
                                        <a href="#!">
                            ...
                            <li class="list-group-item list-group-item-action">
                                <div class="d-flex align-items-center">
                                    <img src="{{URL::asset('build/images/users/avatar-8.jpg')}}" alt="" class="avatar-xs object-cover rounded-circle">
                                    <div class="ms-3 flex-grow-1">
                                        <a href="#!">
                            ...
                            <li class="list-group-item list-group-item-action">
                                <div class="d-flex align-items-center">
                                    <img src="{{URL::asset('build/images/nft/img-03.jpg')}}" alt="" class="avatar-xs object-cover rounded-circle">
                                    <div class="ms-3 flex-grow-1">
                                        <a href="#!">
                            ...
                            <li class="list-group-item list-group-item-action">
                                <div class="d-flex align-items-center">
                                    <img src="{{URL::asset('build/images/nft/img-05.jpg')}}" alt="" class="avatar-xs object-cover rounded-circle">
                                    <div class="ms-3 flex-grow-1">
                                        <a href="#!">
                                            <h6 class="fs-14 mb-1">Timothy Smith</h6>
                                        </a>
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="dash-collection overflow-hidden rounded-top position-relative">
                                <img src="{{URL::asset('build/images/nft/img-03.jpg')}}" alt="" height="220" class="object-cover w-100" />
                        ...
                        <div class="swiper-slide">
                            <div class="dash-collection overflow-hidden rounded-top position-relative">
                                <img src="{{URL::asset('build/images/nft/img-04.jpg')}}" alt="" height="220" class="object-cover w-100" />
                                <div class="content position-absolute bottom-0 m-2 p-2 start-0 end-0 rounded d-flex align-items-center">
                                    <div class="flex-grow-1">
                                        <a href="#!">
                        ...
                        <div class="swiper-slide">
                            <div class="dash-collection overflow-hidden rounded-top position-relative">
                                <img src="{{URL::asset('build/images/nft/img-06.jpg')}}" alt="" height="220" class="object-cover w-100" />
                                <div class="content position-absolute bottom-0 m-2 p-2 start-0 end-0 rounded d-flex align-items-center">
                                    <div class="flex-grow-1">
                                        <a href="#!">
                ...
                <div class="swiper collection-slider">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="d-flex">
                                <div class="flex-shink-0">
                                    <img src="{{URL::asset('build/images/nft/img-02.jpg')}}" alt="" class="avatar-sm object-cover rounded">
                                </div>
                                <div class="ms-3 flex-grow-1">
                        ...
                        <div class="swiper-slide">
                            <div class="d-flex">
                                <div class="flex-shink-0">
                                    <img src="{{URL::asset('build/images/nft/img-01.jpg')}}" alt="" class="avatar-sm object-cover rounded">
                                </div>
                                <div class="ms-3 flex-grow-1">
                                    <a href="pages-profile.">
                        ...
                        <div class="swiper-slide">
                            <div class="d-flex">
                                <div class="flex-shink-0">
                                    <img src="{{URL::asset('build/images/nft/img-04.jpg')}}" alt="" class="avatar-sm object-cover rounded">
                                </div>
                                <div class="ms-3 flex-grow-1">
                                    <a href="pages-profile.">
                        ...
                        <div class="swiper-slide">
                            <div class="d-flex">
                                <div class="flex-shink-0">
                                    <img src="{{URL::asset('build/images/users/avatar-1.jpg')}}" alt="" class="avatar-sm object-cover rounded">
                                </div>
                                <div class="ms-3 flex-grow-1">
                                    <a href="pages-profile.">
