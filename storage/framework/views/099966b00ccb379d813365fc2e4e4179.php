                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarDashboards">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="/users" class="nav-link">Usuarios
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="/clients" class="nav-link">Clientes
                                </a>
                            </li>
                        </ul>
                    </div>
...
<?php /**PATH C:\Users\PC\Desktop\CODIGO\GIT\app-estrategias\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>