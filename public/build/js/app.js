...
(function () {
        ...
        if (document.getElementById("header-lang-img")) {
            if (lang == "en") {
                document.getElementById("header-lang-img").src =
                    "build/images/flags/us.svg";
            } else if (lang == "sp") {
                document.getElementById("header-lang-img").src =
                    "build/images/flags/spain.svg";
            } else if (lang == "gr") {
                document.getElementById("header-lang-img").src =
                    "build/images/flags/germany.svg";
            } else if (lang == "it") {
                document.getElementById("header-lang-img").src =
                    "build/images/flags/italy.svg";
            } else if (lang == "ru") {
                document.getElementById("header-lang-img").src =
                    "build/images/flags/russia.svg";
            } else if (lang == "ch") {
                document.getElementById("header-lang-img").src =
                    "build/images/flags/china.svg";
            } else if (lang == "fr") {
                document.getElementById("header-lang-img").src =
                    "build/images/flags/french.svg";
            } else if (lang == "ar") {
                document.getElementById("header-lang-img").src =
                    "build/images/flags/ae.svg";
            }
    ...
    function twoColumnMenuGenerate() {
        ...
        if (
            ...
            ul.innerHTML =
                '<a href="#" class="logo"><img src="build/images/logo-sm.png" alt="" height="22"></a>';
            Array.from(
                document
        ...
        if (document.getElementsByClassName("notification-check")) {
            function emptyNotification() {
                Array.from(
                    ...
                    if (
                        elem.querySelectorAll(".notification-item").length > 0
                    ) {
                        if (elem.querySelector(".view-all")) {
                            elem.querySelector(".view-all").style.display =
                                "block";
                        }
                    } else {
                        if (elem.querySelector(".view-all")) {
                ...
                switch (isLayoutAttributes["data-layout"]) {
                    ...
                    default:
                        if (
                            ...
                            sessionStorage.getItem("data-layout") == "semibox"
                        ) {
                            getElementUsingTagname("data-layout", "semibox");
                            sessionStorage.setItem("data-layout", "semibox");
                            document.documentElement.setAttribute(
